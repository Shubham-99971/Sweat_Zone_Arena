function calc() {
    ...
    document.getElementById("Final").style = "max-width: 25rem; width: 550px;; left: 567px; border:4px solid lightgoldenrodyellow; border-radius: 5px; padding-left: 58px;  display: block; "
}